...
interface LocalAgendaDataSource {
    ...
    suspend fun getAgendaItemById(agendaItemId: String, itemType: AgendaItemType): AgendaItem?
    ...
    suspend fun deleteAgendaItem(agendaItemId: String, itemType: AgendaItemType)
